...
if($_POST){
	...
	$sql=mysql_query("SELECT verified FROM users WHERE username='$username' AND password='$password'");
    ...
    $mail_body = 	'Hi,
	 ...
	 if(!$mailer->Send())
	  ...
	  {   // $timezone = "Asia/Kolkata";
	    	...
	    	$sql=mysql_query("Update users set verify_code='$randomstring' WHERE username='$username'");
		...
		//echo "verify";
		echo "A link has been send to the address you entered .Please follow the link in the email to verify your account".$username;
	  }
